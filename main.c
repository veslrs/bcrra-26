/*
        Copyright (c) 2025 Eyal Levenberg (eylev@dtu.dk)
                           Fang Zeyuan    (@veslrs)
        Source code to generate results listed and illustrated in BCRRA-26 
        confrence papar. 
*/
...
int main(void)
{
        ...
        // discrete points representing sensor positions
        // note: use `tmk_lispace` (see below) to generate data for a smooth 
        // deflection curve. 
        ...
        //         {1200.0, 300.0, 0.0},
        // };
        // tmk_set_evaluation_points(&mdl, 300, pts);
